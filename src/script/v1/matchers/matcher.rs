...
mod tests {
  ...
  fn it_works1() {
    ...
    if let Ok(MatcherSuccess::Token(token)) = result {
      ...
      assert_eq!(*token.get_value_range(), SourceRange::new(2, 31));
      ...
      assert_eq!(*first.get_value_range(), SourceRange::new(2, 6));
      ...
      assert_eq!(*second.get_value_range(), SourceRange::new(9, 17));
      ...
      assert_eq!(*third.get_value_range(), SourceRange::new(19, 25));
